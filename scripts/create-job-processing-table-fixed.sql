...
DROP POLICY IF EXISTS "Service role can manage all jobs" ON job_processing;
...
CREATE INDEX IF NOT EXISTS idx_job_processing_user_id ON job_processing(user_id);
CREATE INDEX IF NOT EXISTS idx_job_processing_status ON job_processing(status);
CREATE INDEX IF NOT EXISTS idx_job_processing_type ON job_processing(type);
CREATE INDEX IF NOT EXISTS idx_job_processing_created_at ON job_processing(created_at DESC);
...
-- Allow anyone to insert (backend needs to create notifications)
